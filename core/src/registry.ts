...
const UNIVERSAL_CORE: readonly NodeTypeDef[] = [
  ...
  },
  {
    ...
    coreMenu: false,
    accent: '#cbd5e1',
    labels: same('Reference'),
    descriptions: same('A compact link to another node'),
  ...
  },
  {
    ...
    descriptions: same('Shows progression from one state to the next'),
  ...
  },
  {
    ...
    coreMenu: false,
    accent: '#475569',
    labels: same('Decision'),
    descriptions: same('Creates a branch based on a choice or condition'),
    size: { width: 200, height: 60 },
    sizing: 'auto-height',
    ports: [],
  },
  {
    ...
    coreMenu: false,
    accent: '#475569',
    labels: same('Condition'),
    descriptions: same('Represents IF / THEN / ELSE reasoning'),
    size: { width: 200, height: 60 },
    sizing: 'auto-height',
    ports: [],
  },
  {
    ...
    accent: '#475569',
    labels: same('AND'),
    descriptions: same('Requires multiple inputs/conditions'),
  ...
  },
  {
    ...
    accent: '#475569',
    labels: same('OR'),
    descriptions: same('Allows one or more alternatives'),
    size: { width: 120, height: 60 },
    sizing: 'fixed',
    ports: [],
  },
  {
    ...
    accent: '#475569',
    labels: same('NOT'),
    descriptions: same('Negates a condition or statement'),
    size: { width: 120, height: 60 },
    sizing: 'fixed',
    ports: [],
  },
  {
    ...
    accent: '#475569',
    labels: same('Compare'),
    descriptions: same('Places two or more things into deliberate comparison'),
    size: { width: 200, height: 60 },
    sizing: 'auto-height',
    ports: [],
  },
  {
    ...
    accent: '#475569',
    labels: same('Merge'),
    descriptions: same('Combines several paths into one'),
  ...
  },
  {
    ...
    accent: '#475569',
    labels: same('Split'),
    descriptions: same('Branches one input into multiple paths'),
    size: { width: 160, height: 60 },
    sizing: 'fixed',
    ports: [],
  },
  {
    ...
    coreMenu: false,
    accent: '#475569',
    labels: same('Transform'),
    descriptions: same('Represents an input becoming something else'),
    size: { width: 200, height: 60 },
    sizing: 'auto-height',
    ports: [],
  },
  {
    ...
    accent: '#475569',
    labels: same('Filter'),
    descriptions: same('Selects a subset of connected information'),
    size: { width: 200, height: 60 },
    sizing: 'auto-height',
    ports: [],
  },
...
const NOVEL_PACK: readonly NodeTypeDef[] = [
  ...
  // ---------------------------------------------------------------------
  // Design direction 2026-08-12 §6: the core nodes the document names that
  // had no entry. All PORTLESS -- §2 retires the typed-port stack as the
  // everyday connection language, so these join the graph by plain
  // relationship like any ordinary node. They earn FIELDS, not ports (§4).
  // ---------------------------------------------------------------------
  {
    type: 'idea',
    category: 'knowledge',
    ...
    accent: '#fbbf24',
    labels: same('Idea'),
    descriptions: same('A possibility worth developing — lighter than a claim, looser than a note'),
  ...
  },
  {
    ...
    coreMenu: false,
    accent: '#94a3b8',
    labels: { universal: 'Quote', novel: 'Quote', sermon: 'Citation' },
    descriptions: {
      universal: "Someone else's words, kept verbatim with their speaker and place",
      novel: 'A line worth keeping — epigraph, overheard speech, borrowed phrase',
      sermon: 'A quotation from a commentator or source',
    },
  ...
  },
  {
    ...
    coreMenu: false,
    accent: '#38bdf8',
    labels: { universal: 'Concept', novel: 'Concept', sermon: 'Doctrine' },
    descriptions: {
      universal: 'An abstract idea: technical, theological, scientific — whatever the project studies',
      novel: 'An idea the story is built on',
      sermon: 'A doctrine the text teaches',
    },
  ...
  },
  {
    ...
    labels: same('Theme'),
    descriptions: {
      universal: 'A recurring idea that ties scenes, chapters, evidence or claims together',
      novel: 'What the book keeps coming back to',
      sermon: 'The thread running through the passage',
    },
  ...
  },
  {
    ...
    coreMenu: false,
    accent: '#2dd4bf',
    labels: same('Definition'),
    descriptions: same('What a term means — for study, language work, or any field with vocabulary'),
  ...
  },
  {
    ...
    coreMenu: false,
    accent: '#4ade80',
    labels: same('Evidence'),
    descriptions: same('What supports a claim, and how strongly — with its source and its limits'),
  ...
  },
  {
    ...
    coreMenu: false,
    accent: '#34d399',
    labels: same('Argument'),
    descriptions: same('Structured reasoning: claims, premises, evidence and the conclusion they reach'),
  ...
  },
  {
    ...
    coreMenu: false,
    accent: '#fb7185',
    labels: same('Counterargument'),
    descriptions: same('The opposing position, kept alongside the response to it'),
