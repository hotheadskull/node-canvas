...
export function LocationNode({ data, selected }: NodeProps<AppNode>) {
  return (
    ...
    >
      <Handle type="target" position={Position.Top} className="w-3 h-3 rounded-full border-2 border-[#151518] z-50 transition-transform hover:scale-125 bg-[#10b981]" />
      ...
      <Handle type="source" position={Position.Bottom} className="w-3 h-3 rounded-full border-2 border-[#151518] z-50 transition-transform hover:scale-125 bg-[#10b981]" />
    </div>
    </>
  );
}
