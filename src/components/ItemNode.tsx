...
export const ItemNode = memo(({ id, data, selected }: any) => {
  ...
  return (
    ...
    `}>
      <Handle type="target" position={Position.Top} className="w-3 h-3 bg-[#10b981] border-2 border-[#111114] rounded-full z-50 -top-2" />
      ...
      <div className="p-4 bg-[#0a0c0f] rounded-b-lg flex flex-col gap-4">
        ...
        <div className="grid grid-cols-2 gap-3">
          <div>
            ...
            <input
              type="text"
              className="w-full bg-[#111114] border border-[#2a2a35] rounded p-2 text-xs text-emerald-100/80 focus:outline-none focus:border-[#10b981] transition-colors"
              value={data.origin || ''}
        ...
        <div>
          ...
          <textarea
            className="w-full bg-[#111114] border border-[#2a2a35] rounded p-2 text-xs text-emerald-100/80 resize-none focus:outline-none focus:border-[#10b981] transition-colors"
            rows={2}
      ...
      <Handle type="source" position={Position.Bottom} className="w-3 h-3 bg-[#10b981] border-2 border-[#111114] rounded-full z-50 -bottom-2" />
    </div>
    </>
  );
});
