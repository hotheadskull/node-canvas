...
export const NODE_DEFS: NodeDef[] = [
  // ---------- Tier 1: Writing surfaces ----------
  {
    ...
    labels: { novel: 'Master Pitch', sermon: 'Master Topic', universal: 'Big Idea' },
    descriptions: {
      novel: 'The core logline and synopsis everything serves',
      sermon: 'The core message and thesis everything serves',
      universal: 'The one governing idea the project serves',
    },
  ...
  },
  {
    ...
    labels: { novel: 'Concept', sermon: 'Theological Concept', universal: 'Concept' },
    descriptions: {
      novel: 'Worldbuilding, history, and how things work',
      sermon: 'Doctrine, exegesis, and deep dives',
      universal: 'An idea that needs its own card',
    },
    size: { width: 340, height: 280 },
  },
  {
  ...
  },
  {
    ...
    descriptions: {
      novel: 'A quick short-form thought',
      sermon: 'A quick short-form thought',
      universal: 'A quick short-form thought',
    },
  ...
  },
  {
    ...
    labels: { novel: 'Crucible', sermon: 'Tension Point', universal: 'Crucible' },
    descriptions: {
      novel: 'Combine characters & places to forge conflict',
      sermon: 'Put truths in tension to sharpen the message',
      universal: 'Combine cards and see what conflict emerges',
    },
    size: { width: 340, height: 300 },
  },
  {
    type: 'alias', tier: 'structure', accent: '#f0c050', inMenu: true,
    labels: { novel: 'Alias Pin', sermon: 'Alias Pin', universal: 'Alias Pin' },
    descriptions: {
